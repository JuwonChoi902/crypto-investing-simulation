...
function useThemeAwareLayoutOptions(): DeepPartial<LayoutOptions> {
  ...
  const [layoutOptions, setLayoutOptions] = React.useState<DeepPartial<LayoutOptions>>(
...
function HeroChart(): JSX.Element {
  ...
  const [chartContainerClassName, setChartContainerClassName] = React.useState<string>(
    styles.HeroChartContainer,
  );
  ...
  return <div className={[chartContainerClassName, chartStyle.ChartContainer].join(' ')} ref={ref}></div>;
}
    ...
    <div className={styles.RootContainer}>
      <div className={styles.HeroContainer}>
        ...
        <div className={styles.HeroTextContainer}>
          ...
          <div className={styles.HeroButtonsContainer}>
            <a className={[styles.HeroButton, styles.HeroButtonPrimary].join(' ')} href='docs'>
              Get Started
            </a>
            <a className={styles.HeroButton} href='docs/api'>
              API Reference
            </a>
          </div>
        </div>
      ...
      <div className={styles.BelowChartContainer}>
        <div className={styles.LargeTextContainer}>
          <h1>Less is more</h1>
          <div>
            Millions of websites still use static pictures for showing financial charts. The old way is not
            interactive and doesn&apos;t scale with various devices. Pictures always had a huge advantage of
            their small size and fast loading&nbsp;—&nbsp;but no more!
          </div>
        </div>
        <div className={styles.LargeCardContainer}>
          <div className={[styles.LargeCard, styles.LargeCard1].join(' ')}>
            ...
            <p>
              Our charting solutions were engineered from the start to work with huge data arrays. Charts stay
              responsive and nimble even with thousands of bars even with updates multiple times per second
              with new ticks.
            </p>
          </div>
          <div className={[styles.LargeCard, styles.LargeCard2].join(' ')}>
            ...
            <div className={styles.LargeCardInnerSpacer2} />
            <p>
              Intelligently adapts to any device. Charts are carefully engineered for best interactivity, both
              for powerful desktops with a mouse, and touch-optimized for tablets and phones.
            </p>
          </div>
          <div className={[styles.LargeCard, styles.LargeCard3].join(' ')}>
            ...
            <div className={styles.LargeCardInnerSpacer2} />
            <p>
              Charting is our core. TradingView charts are used by tens of thousands of websites, apps and
              financial portals, as well as millions of traders around the world. You can be sure that
              we&apos;ve included everything you need, starting from popular chart types to advanced price
              scaling.
            </p>
          </div>
        </div>
        <div className={styles.SmallCardContainer}>
          <div className={[styles.SmallCard, styles.SmallCard1].join(' ')}>
            ...
            <p>
              Built for developers, by developers. Charts are rich in features and easy to integrate — so you
              can integrate with a breeze.
            </p>
          </div>
          ...
          <div className={[styles.SmallCard, styles.SmallCard3].join(' ')}>
            ...
            <h3>Open-source </h3>
            <p>
              Maintained by TradingView. Hosted on GitHub. Licensed under the Apache License, Version 2.0.
          ...
          <div className={[styles.SmallCard, styles.SmallCard4].join(' ')}>
            ...
            <p>
              Change the standard look & feel to match your style with perfection. There are many premade
              examples that you can copy & paste.
            </p>
          </div>
        </div>
      </div>
